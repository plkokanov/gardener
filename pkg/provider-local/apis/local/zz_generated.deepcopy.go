...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ControlPlaneEncryptionConfig.
func (in *ControlPlaneEncryptionConfig) DeepCopy() *ControlPlaneEncryptionConfig {
	if in == nil {
		return nil
	}
	out := new(ControlPlaneEncryptionConfig)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *ControlPlaneEncryptionConfig) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
