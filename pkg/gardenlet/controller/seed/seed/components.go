...
func (r *Reconciler) instantiateComponents(
	...
	c.verticalPodAutoscaler, err = r.newVerticalPodAutoscaler(seed.GetInfo().Spec.Settings, secretsManager, isManagedSeed)
	if err != nil {
		return
	}
...
func (r *Reconciler) newVerticalPodAutoscaler(settings *gardencorev1beta1.SeedSettings, secretsManager secretsmanager.Interface, isManagedSeed bool) (component.DeployWaiter, error) {
