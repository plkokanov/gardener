...
func (b *Botanist) DeployPrometheus(ctx context.Context) error {
	...
	b.Shoot.Components.ControlPlane.Prometheus.SetCentralScrapeConfigs(shootprometheus.CentralScrapeConfigs(b.Shoot.ControlPlaneNamespace, caSecret.Name, b.Shoot.IsWorkerless, b.Shoot.UsePrometheusForVPARecommenderMetricsHistory))
